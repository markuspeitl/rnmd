...
from rnmd.util.file_tool import get_file_contents, is_file_exists(source_location)
...
def document_exists(source_location):
    return is_url(source_location) and page_exists(source_location) or is_file_exists(source_location)(source_location)
